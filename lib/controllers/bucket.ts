...
import { S3CorsConfiguration, S3WebsiteConfiguration } from '../models/config';
import { utf8BodyParser } from '../utils';
 ...
 */
export const deleteBucket = async function deleteBucket(ctx) {
 ...
 */
export const deleteBucketCors = async function deleteBucketCors(ctx) {
 ...
 */
export const deleteBucketWebsite = async function deleteBucketWebsite(ctx) {
 ...
 */
export const getBucketCors = async function getBucketCors(ctx) {
 ...
 */
export const getBucketLocation = async function getBucketLocation(ctx) {
 ...
 */
export const getBucketWebsite = async function getBucketWebsite(ctx) {
  const config = await ctx.store.getSubresource(
    ctx.params.bucket,
    undefined,
    'website',
 ...
 */
export const putBucket = async function putBucket(ctx) {
  const bucketName = ctx.params.bucket;
  /**
 ...
 */
export const putBucketCors = async function putBucketCors(ctx) {
 ...
 */
export const putBucketWebsite = async function putBucketWebsite(ctx) {
  await utf8BodyParser(ctx);
