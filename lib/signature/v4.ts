...
import { parseISO8601String } from '../utils';
 ...
 * @param {*} signature
 */
export const getStringToSign = function (
  canonicalRequest,
 ...
 */
export const getSigningKey = function (secretKey, date, region, service) {
 ...
 */
export const aws4SignatureBodyParser = function (ctx) {
  ctx.request.body =
